...
| CI remoto                                                  | `baseline-verified`                | El CI remoto `32682656294` verificó `d829098` en Ubuntu/PostGIS, incluyendo el nuevo `@wachuma/importer-garden`; la advertencia de Node 20 pertenece a las actions y no afecta el gate.                                                                                                                     |
...
4. Conservar el SBOM asociado a la corrida remota `32682656294`; el ledger de
