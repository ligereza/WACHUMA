...
| CI remoto                                                  | `pending-remote-verification`      | La compuerta local del nuevo workspace pasa; el CI de Ubuntu/PostGIS debe verificar este commit antes de actualizar la evidencia remota.                                                                                                                                                                    |
...
4. Ejecutar CI después de este commit y conservar el SBOM asociado; la última
   corrida remota sólo cubre la base anterior al ledger de jardín.
