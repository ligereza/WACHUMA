...
| [FungalTraits](https://github.com/traitecoevo/fungaltraits)                   | Traits ecológicos/funcionales, metadatos, versión de release, DOI y citación.                                    | `DESCRIPTION` declara MIT para el paquete; Zenodo v0.0.3 declara `Other (Open)` sin descripción adicional. Las mediciones se mantienen en staging hasta resolver derechos por release/estudio. |
