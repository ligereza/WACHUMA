...
| FungalTraits               | MIT + `LICENSE` para paquete; derechos del dataset y estudios por release | Importador de snapshots en staging, con DOI, checksum y fuente por medición    | Verificar licencia exacta del snapshot antes de publicar traits        |
...
| De Bonis, Pecchia & Nicoletto (2026) | CC BY 4.0 según el artículo abierto de Frontiers in Horticulture                                                                                                                                                                                                                                                                                                                       | Fuente académica para la guía experimental de cultivo de _Pleurotus ostreatus_   | Conservar DOI, atribución, contexto de Penn State y límites del ensayo; no presentar sus condiciones como protocolo universal. |
